...
tableHux %>% 
  # cell properties
        set_all_padding(4) %>% # sets padding, for single direction `left_padding`, `right_padding`, `top_padding` and `bottom_padding`
    ...
    #  table properties
      set_caption("Pots of jam for sale") %>% # caption of table
      set_font_size(10)   %>% 
      ...
      set_tb_padding(2)                                    %>% 
      set_label("tab:props")                               %>% 
      set_col_width(c(.2, .2,.2,.2,.2,.2,.2,.2,.2))     %>% 
