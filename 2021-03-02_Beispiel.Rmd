...
header-includes:
  ...
  # - \usepackage{tikz}
  # https://stackoverflow.com/questions/47774886/controlling-space-between-lines-or-rows-in-tables-using-papaja-with-r-markdown-f
  # ## Möglichkeit zur Reduzierung von Zeilenabständen
  # - \usepackage{setspace}
...
tableKableData <- Bezirk %>% 
  ...
  tableKable <- kableExtra::kbl(
    ...
    linesep = "",
    caption = "Kable: Stadtbezirk Innenstadt-West: Bevölkerung im Zeitvergleich 2013 bis 2018",
    # label = "",
    col.names = linebreak(
      c(
...
```{r echo = FALSE, fig.cap="Beschriftung 1" } 
HWBVBarPlot
```
