...
tableKable <- Bezirk %>% 
  mutate(
    ...
    Variable = stringr::str_replace(Variable,"Sonstige", "Sonstige$^{1}$"),
...
Es existieren zahlreiche Beispiele, wie im Buch ["RMarkdown for Scientists](https://rmd4sci.njtierney.com/) oder Sammlungen von [Template Vorlage wissenschaftlicher Journals](https://github.com/rstudio/rticles). Packages für Latex finden sich auf [CTAN](https://www.ctan.org/). 

\Begin{multicols}{2}

Bisher verwendet werden:

- [Multicol - mehrspaltige Layouts](https://www.ctan.org/pkg/multicol)
- [fancyhdr - Kopf- /Fußzeile](https://ctan.org/pkg/fancyhdr?lang=de)
- [caption - Tabellenüberschriften](https://ctan.org/pkg/caption?lang=de)
- [xcolor - Definition von Farben](https://ctan.org/pkg/xcolor?lang=de)
- [tocloft - Erweiterte Optionen für Inhaltsverzeichnisse](https://www.ctan.org/pkg/tocloft)
\newline
\newline
...
- [geometry - flexible Dokumentformatierung](https://ctan.org/pkg/geometry?lang=en)
- [pdfpages - Einbindung von PDF Dokumenten (Umschlag?)](https://ctan.org/pkg/pdfpages)
- [tikz & PGF - Skalierung von Grafiken in Latex](https://ctan.org/pkg/pgf?lang=de)
- [fontspec - Erweiterte Schrift Auswahl und Konfiguration](https://www.ctan.org/pkg/fontspec)
...
```{r plot Pyramide 2-spaltig, echo = FALSE, fig.align = 'right'}
...
- manche Grafiken sind für 2 Spalten ungeeignet -> Entscheidungen welche Grafik in welcher Form wie verwendet wird?
